...
/**
 * = WykladowcasItemJednostkiLekcyjneThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = WykladowcasItemJednostkiLekcyjneThymeleafController.class)
@Component
public class WykladowcasItemJednostkiLekcyjneThymeleafLinkFactory implements MethodLinkFactory<WykladowcasItemJednostkiLekcyjneThymeleafController> {
     ...
     * @return Class
     */
    public Class<WykladowcasItemJednostkiLekcyjneThymeleafController> getControllerClass() {
        return WykladowcasItemJednostkiLekcyjneThymeleafController.class;
    }
