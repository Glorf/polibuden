...
/**
 * = PrzedmiotsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PrzedmiotsItemThymeleafController.class)
@Component
public class PrzedmiotsItemThymeleafLinkFactory implements MethodLinkFactory<PrzedmiotsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PrzedmiotsItemThymeleafController> getControllerClass() {
        return PrzedmiotsItemThymeleafController.class;
    }
