...
/**
 * = DziensItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DziensItemThymeleafController.class)
@Component
public class DziensItemThymeleafLinkFactory implements MethodLinkFactory<DziensItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<DziensItemThymeleafController> getControllerClass() {
        return DziensItemThymeleafController.class;
    }
