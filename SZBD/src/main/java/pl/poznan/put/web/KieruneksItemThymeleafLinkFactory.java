...
/**
 * = KieruneksItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = KieruneksItemThymeleafController.class)
@Component
public class KieruneksItemThymeleafLinkFactory implements MethodLinkFactory<KieruneksItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<KieruneksItemThymeleafController> getControllerClass() {
        return KieruneksItemThymeleafController.class;
    }
