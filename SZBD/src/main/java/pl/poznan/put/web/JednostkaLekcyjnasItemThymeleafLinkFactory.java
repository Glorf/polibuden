...
/**
 * = JednostkaLekcyjnasItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = JednostkaLekcyjnasItemThymeleafController.class)
@Component
public class JednostkaLekcyjnasItemThymeleafLinkFactory implements MethodLinkFactory<JednostkaLekcyjnasItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<JednostkaLekcyjnasItemThymeleafController> getControllerClass() {
        return JednostkaLekcyjnasItemThymeleafController.class;
    }
