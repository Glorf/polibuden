...
/**
 * = ZespolsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ZespolsItemThymeleafController.class)
@Component
public class ZespolsItemThymeleafLinkFactory implements MethodLinkFactory<ZespolsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<ZespolsItemThymeleafController> getControllerClass() {
        return ZespolsItemThymeleafController.class;
    }
