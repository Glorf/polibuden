...
/**
 * = SalasCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SalasCollectionThymeleafController.class)
@Component
public class SalasCollectionThymeleafLinkFactory implements MethodLinkFactory<SalasCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<SalasCollectionThymeleafController> getControllerClass() {
        return SalasCollectionThymeleafController.class;
    }
