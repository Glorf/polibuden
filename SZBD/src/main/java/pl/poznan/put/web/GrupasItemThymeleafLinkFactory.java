...
/**
 * = GrupasItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GrupasItemThymeleafController.class)
@Component
public class GrupasItemThymeleafLinkFactory implements MethodLinkFactory<GrupasItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<GrupasItemThymeleafController> getControllerClass() {
        return GrupasItemThymeleafController.class;
    }
