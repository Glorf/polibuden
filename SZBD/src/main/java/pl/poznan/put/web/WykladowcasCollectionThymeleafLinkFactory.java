...
/**
 * = WykladowcasCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = WykladowcasCollectionThymeleafController.class)
@Component
public class WykladowcasCollectionThymeleafLinkFactory implements MethodLinkFactory<WykladowcasCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<WykladowcasCollectionThymeleafController> getControllerClass() {
        return WykladowcasCollectionThymeleafController.class;
    }
