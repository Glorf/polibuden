...
/**
 * = PrzedmiotsItemJednostkiLekcyjneThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PrzedmiotsItemJednostkiLekcyjneThymeleafController.class)
@Component
public class PrzedmiotsItemJednostkiLekcyjneThymeleafLinkFactory implements MethodLinkFactory<PrzedmiotsItemJednostkiLekcyjneThymeleafController> {
     ...
     * @return Class
     */
    public Class<PrzedmiotsItemJednostkiLekcyjneThymeleafController> getControllerClass() {
        return PrzedmiotsItemJednostkiLekcyjneThymeleafController.class;
    }
