...
/**
 * = BudyneksItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = BudyneksItemThymeleafController.class)
@Component
public class BudyneksItemThymeleafLinkFactory implements MethodLinkFactory<BudyneksItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<BudyneksItemThymeleafController> getControllerClass() {
        return BudyneksItemThymeleafController.class;
    }
