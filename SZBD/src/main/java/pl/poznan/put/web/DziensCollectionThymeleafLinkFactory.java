...
/**
 * = DziensCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = DziensCollectionThymeleafController.class)
@Component
public class DziensCollectionThymeleafLinkFactory implements MethodLinkFactory<DziensCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<DziensCollectionThymeleafController> getControllerClass() {
        return DziensCollectionThymeleafController.class;
    }
