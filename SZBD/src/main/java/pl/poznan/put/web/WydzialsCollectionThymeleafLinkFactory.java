...
/**
 * = WydzialsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = WydzialsCollectionThymeleafController.class)
@Component
public class WydzialsCollectionThymeleafLinkFactory implements MethodLinkFactory<WydzialsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<WydzialsCollectionThymeleafController> getControllerClass() {
        return WydzialsCollectionThymeleafController.class;
    }
