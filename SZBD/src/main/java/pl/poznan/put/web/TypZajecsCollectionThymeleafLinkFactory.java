...
/**
 * = TypZajecsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = TypZajecsCollectionThymeleafController.class)
@Component
public class TypZajecsCollectionThymeleafLinkFactory implements MethodLinkFactory<TypZajecsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<TypZajecsCollectionThymeleafController> getControllerClass() {
        return TypZajecsCollectionThymeleafController.class;
    }
