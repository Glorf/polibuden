...
/**
 * = JednostkaLekcyjnasCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = JednostkaLekcyjnasCollectionThymeleafController.class)
@Component
public class JednostkaLekcyjnasCollectionThymeleafLinkFactory implements MethodLinkFactory<JednostkaLekcyjnasCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<JednostkaLekcyjnasCollectionThymeleafController> getControllerClass() {
        return JednostkaLekcyjnasCollectionThymeleafController.class;
    }
