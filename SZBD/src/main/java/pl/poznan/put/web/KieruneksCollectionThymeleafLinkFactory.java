...
/**
 * = KieruneksCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = KieruneksCollectionThymeleafController.class)
@Component
public class KieruneksCollectionThymeleafLinkFactory implements MethodLinkFactory<KieruneksCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<KieruneksCollectionThymeleafController> getControllerClass() {
        return KieruneksCollectionThymeleafController.class;
    }
