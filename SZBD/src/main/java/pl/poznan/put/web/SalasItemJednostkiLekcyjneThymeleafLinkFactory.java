...
/**
 * = SalasItemJednostkiLekcyjneThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SalasItemJednostkiLekcyjneThymeleafController.class)
@Component
public class SalasItemJednostkiLekcyjneThymeleafLinkFactory implements MethodLinkFactory<SalasItemJednostkiLekcyjneThymeleafController> {
     ...
     * @return Class
     */
    public Class<SalasItemJednostkiLekcyjneThymeleafController> getControllerClass() {
        return SalasItemJednostkiLekcyjneThymeleafController.class;
    }
