...
/**
 * = StudentsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = StudentsItemThymeleafController.class)
@Component
public class StudentsItemThymeleafLinkFactory implements MethodLinkFactory<StudentsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<StudentsItemThymeleafController> getControllerClass() {
