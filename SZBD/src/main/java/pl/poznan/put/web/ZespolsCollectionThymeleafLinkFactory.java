...
/**
 * = ZespolsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ZespolsCollectionThymeleafController.class)
@Component
public class ZespolsCollectionThymeleafLinkFactory implements MethodLinkFactory<ZespolsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ZespolsCollectionThymeleafController> getControllerClass() {
        return ZespolsCollectionThymeleafController.class;
    }
