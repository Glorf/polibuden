...
/**
 * = StudentsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = StudentsCollectionThymeleafController.class)
@Component
public class StudentsCollectionThymeleafLinkFactory implements MethodLinkFactory<StudentsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<StudentsCollectionThymeleafController> getControllerClass() {
