...
/**
 * = LiteraturasItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = LiteraturasItemThymeleafController.class)
@Component
public class LiteraturasItemThymeleafLinkFactory implements MethodLinkFactory<LiteraturasItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<LiteraturasItemThymeleafController> getControllerClass() {
        return LiteraturasItemThymeleafController.class;
    }
