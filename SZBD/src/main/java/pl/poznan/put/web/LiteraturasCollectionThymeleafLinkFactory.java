...
/**
 * = LiteraturasCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = LiteraturasCollectionThymeleafController.class)
@Component
public class LiteraturasCollectionThymeleafLinkFactory implements MethodLinkFactory<LiteraturasCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<LiteraturasCollectionThymeleafController> getControllerClass() {
        return LiteraturasCollectionThymeleafController.class;
    }
