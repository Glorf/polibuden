...
/**
 * = ZespolsItemWykladowcyThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ZespolsItemWykladowcyThymeleafController.class)
@Component
public class ZespolsItemWykladowcyThymeleafLinkFactory implements MethodLinkFactory<ZespolsItemWykladowcyThymeleafController> {
     ...
     * @return Class
     */
    public Class<ZespolsItemWykladowcyThymeleafController> getControllerClass() {
        return ZespolsItemWykladowcyThymeleafController.class;
    }
