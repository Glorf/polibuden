...
/**
 * = WydzialsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = WydzialsItemThymeleafController.class)
@Component
public class WydzialsItemThymeleafLinkFactory implements MethodLinkFactory<WydzialsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<WydzialsItemThymeleafController> getControllerClass() {
        return WydzialsItemThymeleafController.class;
    }
