...
/**
 * = WykladowcasItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = WykladowcasItemThymeleafController.class)
@Component
public class WykladowcasItemThymeleafLinkFactory implements MethodLinkFactory<WykladowcasItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<WykladowcasItemThymeleafController> getControllerClass() {
        return WykladowcasItemThymeleafController.class;
    }
