...
/**
 * = GrupasCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GrupasCollectionThymeleafController.class)
@Component
public class GrupasCollectionThymeleafLinkFactory implements MethodLinkFactory<GrupasCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<GrupasCollectionThymeleafController> getControllerClass() {
        return GrupasCollectionThymeleafController.class;
    }
