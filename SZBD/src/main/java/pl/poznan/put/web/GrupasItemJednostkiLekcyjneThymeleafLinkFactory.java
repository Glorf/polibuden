...
/**
 * = GrupasItemJednostkiLekcyjneThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = GrupasItemJednostkiLekcyjneThymeleafController.class)
@Component
public class GrupasItemJednostkiLekcyjneThymeleafLinkFactory implements MethodLinkFactory<GrupasItemJednostkiLekcyjneThymeleafController> {
     ...
     * @return Class
     */
    public Class<GrupasItemJednostkiLekcyjneThymeleafController> getControllerClass() {
        return GrupasItemJednostkiLekcyjneThymeleafController.class;
    }
