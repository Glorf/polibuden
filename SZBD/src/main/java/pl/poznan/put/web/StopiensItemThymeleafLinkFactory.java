...
/**
 * = StopiensItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = StopiensItemThymeleafController.class)
@Component
public class StopiensItemThymeleafLinkFactory implements MethodLinkFactory<StopiensItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<StopiensItemThymeleafController> getControllerClass() {
        return StopiensItemThymeleafController.class;
    }
