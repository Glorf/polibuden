...
/**
 * = BudyneksCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = BudyneksCollectionThymeleafController.class)
@Component
public class BudyneksCollectionThymeleafLinkFactory implements MethodLinkFactory<BudyneksCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<BudyneksCollectionThymeleafController> getControllerClass() {
        return BudyneksCollectionThymeleafController.class;
    }
