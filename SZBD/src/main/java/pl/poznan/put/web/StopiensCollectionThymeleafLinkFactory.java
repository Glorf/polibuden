...
/**
 * = StopiensCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = StopiensCollectionThymeleafController.class)
@Component
public class StopiensCollectionThymeleafLinkFactory implements MethodLinkFactory<StopiensCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<StopiensCollectionThymeleafController> getControllerClass() {
        return StopiensCollectionThymeleafController.class;
    }
