...
/**
 * = TypZajecsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = TypZajecsItemThymeleafController.class)
@Component
public class TypZajecsItemThymeleafLinkFactory implements MethodLinkFactory<TypZajecsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<TypZajecsItemThymeleafController> getControllerClass() {
        return TypZajecsItemThymeleafController.class;
    }
