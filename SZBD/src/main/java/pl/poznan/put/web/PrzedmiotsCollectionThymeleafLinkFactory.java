...
/**
 * = PrzedmiotsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PrzedmiotsCollectionThymeleafController.class)
@Component
public class PrzedmiotsCollectionThymeleafLinkFactory implements MethodLinkFactory<PrzedmiotsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PrzedmiotsCollectionThymeleafController> getControllerClass() {
        return PrzedmiotsCollectionThymeleafController.class;
    }
