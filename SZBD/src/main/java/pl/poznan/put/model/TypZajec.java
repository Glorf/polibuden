...
@Entity
@EntityFormat("#{nazwa}")
@Table(name = "typ_zajec", indexes = {@Index(name = "typ_zajec_idx",  columnList="id", unique = true)})
public class TypZajec {
     ...
     */
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "typ_zajec_generator")
    @SequenceGenerator(name="typ_zajec_generator", sequenceName = "typ_zajec_seq", allocationSize = 1)
     ...
     *
     */
    @OneToMany(cascade = { javax.persistence.CascadeType.MERGE, javax.persistence.CascadeType.PERSIST }, fetch = FetchType.LAZY, mappedBy = "typ")
     ...
     * @return TypZajec
     */
    public TypZajec setVersion(Integer version) {
     ...
     * @return TypZajec
     */
    public TypZajec setNazwa(String nazwa) {
        this.nazwa = nazwa;
        return this;
    }
     ...
     * @return TypZajec
     */
    public TypZajec setJednostkiLekcyjne(Set<JednostkaLekcyjna> jednostkiLekcyjne) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TypZajec)) {
            return false;
        }
        return getId() != null && Objects.equals(getId(), ((TypZajec) obj).getId());
    }
    ...
    public String toString() {
        return "TypZajec {" + "id='" + id + '\'' + ", version='" + version + '\'' + ", nazwa='" + nazwa + '\'' + "}" + super.toString();
    }
