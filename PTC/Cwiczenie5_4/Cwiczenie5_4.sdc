## Generated SDC file "Cwiczenie5_4.sdc"
...
create_clock -name {zegar} -period 12.000 [get_ports {CLOCK_50}]
...
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[0]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[1]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[2]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[3]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[4]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[5]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[6]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[7]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[8]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[9]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[10]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[11]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[12]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[13]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[14]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[15]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[16]}]
set_input_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {iSW[17]}]
...
set_output_delay -add_delay  -clock [get_clocks {zegar}]  1.000 [get_ports {oLEDR[0]}]
